...
@section('title', 'Mon Profil - Vacataire')
                    ...
                    <div class="row text-center mb-5">
                        <div class="col-md-4">
                            <div class="stat-card p-3 rounded-3">
                                ...
                                <p class="text-muted small mb-0">UEs Assignées</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card p-3 rounded-3">
                                ...
                                <p class="text-muted small mb-0">Volume Horaire</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card p-3 rounded-3">
...
<div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <form action="{{ route('vacataire.profile.update') }}" method="POST">
                @csrf
                @method('PUT')
...
<div class="modal fade" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <form action="{{ route('vacataire.password.update') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body px-4">
                    <div class="mb-3">
