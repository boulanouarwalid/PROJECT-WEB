      ...
      <div class="col-md-4 col-lg-5 d-flex justify-content-end ">
        ...
        <div class="dropdown">
          <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="{{ asset('assets/images/profil_img.jpg')}}" alt="Photo profil" width="32" height="32" class="rounded-circle me-2 mt-1 ">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
            <li>
              <div class="dropdown-item d-flex align-items-center">
                <img src="{{ asset('assets/images/profil_img.jpg')}}" alt="Photo profil" width="40" height="40" class="rounded-circle me-2">
                <div>
            ...
            <li>
              <form  action="{{ route('deconexion') }}"  method="GET">
                  @csrf
                  @method('GET')
