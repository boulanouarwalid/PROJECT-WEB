...
@section('title', 'Mon Profil - Coordinateur')
                    ...
                    <div class="row text-center mb-5">
                        <div class="col-md-4">
                            <div class="stat-card p-3 rounded-3">
                                ...
                                <h4 class="fw-bold mb-1 text-primary">{{ $stats['ues'] ?? 0 }}</h4>
                                <p class="text-muted small mb-0">UEs Gérées</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card p-3 rounded-3">
                                ...
                                <h4 class="fw-bold mb-1 text-success">{{ $stats['affectations'] ?? 0 }}</h4>
                                <p class="text-muted small mb-0">Affectations</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card p-3 rounded-3">
                        ...
                        <div class="col-md-6">
                            <div class="info-card p-3 rounded-3 mb-3">
                                ...
                                <div class="info-item d-flex mb-3">
                                    ...
                                    <div>
                                        <h6 class="text-muted small mb-1">Filière coordonnée</h6>
                                        <p class="mb-0">{{ auth()->user()->currentCoordinatedFiliere()->nom ?? 'Aucune' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <form action="{{ route('coordinateur.profile.update') }}" method="POST">
                @csrf
                @method('PUT')
...
<div class="modal fade" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <form action="{{ route('coordinateur.password.update') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body px-4">
                    <div class="mb-3">
